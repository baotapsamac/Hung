                            ...
                            Contexts const & contexts_ )
{
       ...
       Dictionary::WebMultimediaDownload::isAudioUrl( url ) )
  {
    ...
    {
      QMessageBox::critical( this, "TĐVK", tr( "The referenced resource doesn't exist." ) );
      return;
    }
    else
      ...
      if ( (*i)->dataSize() >= 0 )
      {
             ...
             Dictionary::WebMultimediaDownload::isAudioUrl( resourceDownloadUrl ) )
        {
...
#endif
          {
            ...
            {
              QMessageBox::critical( this, "TĐVK", tr( "Failed to run a player to play sound file: %1" ).arg( e.what() ) );
            }
          }
        }
        else
        {
...

          {
            ...
            {
              QMessageBox::critical( this, "TĐVK", tr( "Failed to create temporary file." ) );
              return;
            }
