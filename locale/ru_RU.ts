...
<context>
    ...
    <message>
        ...
        <translation>Словарь TDNDict, версия </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Справка TDNDict</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Версия &lt;b&gt;%1&lt;/b&gt; программы TDNDict доступа для загрузки.&lt;br&gt;
...
Чтобы найти сами символы &apos;*&apos;, &apos;?&apos;, &apos;[&apos;, &apos;]&apos;, используйте &apos;\*&apos;, &apos;\?&apos;, &apos;\[&apos;, &apos;\]&apos; соответственно.</translation>
    ...
    <message>
        ...
        <translation>О программе TDNDict</translation>
    </message>
    <message>
...
того, как слово было выделено.</translation>
    ...
    <message>
        ...
        <translation>Горячие клавиши являются глобальными и работают из любой программы и в любом состоянии, до тех пор пока TDNDict работает в фоне.</translation>
    </message>
    <message>
...
при единственной открытой вкладке.</translation>
    ...
    <message>
        ...
        <translation>Автоматически запускать TDNDict при старте операционной системы.</translation>
    </message>
    <message>
...
Enable this option to workaround the problem.</source>
        <translation>Некоторые сайты опознают TDNDict по заголовкам HTTP и блокируют запросы.
Включите эту опцию, чтобы обойти проблему.</translation>
    ...
    <message>
        ...
        <translation>Не указывать TDNDict в заголовках HTTP</translation>
    </message>
    <message>
...
This technology works only with some programs that support it.
It is not needed to select this option if you don&apos;t use such programs.</source>
        <translation>Использовать специальный запрос TDNDict для поиска слова под курсором.
Эта технология работает лишь с теми программами, что поддерживают её.
Если вы не пользуетесь такими программами, включать эту опцию не нужно.</translation>
    </message>
    <message>
        ...
        <translation>Использовать запрос &amp;TDNDict</translation>
    </message>
    <message>
...
you are browsing. If some site breaks because of this, try disabling this.</source>
        <translation>Включение этой опции позволяет TDNDict блокировать большую часть
...
TDNDict. Если новая версия появилась, программа
...
%GDBIG5% для Big-5, %GDBIG5HKSCS% для Big5-HKSCS, %GDGBK% для GBK и GB18030, %GDSHIFTJIS% для Shift-JIS.</translation>
    ...
    <message>
        ...
        <translation>Живое произношение с сайта &lt;a href=&quot;http://www.forvo.com/&quot;&gt;forvo.com&lt;/a&gt;. Сайт позволяет людям записывать и обмениваться произношениями слов. Вы можете прослушивать их из TDNDict.</translation>
    </message>
    <message>
