  ...
  QStringList const & dictIDs ) const
{
  ...
  if ( groupId == Instances::Group::HelpGroupId )
  {
    ...
    {
      result += tr(
                  "<h3 align=\"center\">Chào mừng bạn đến với <b>Từ điển chuyên ngành Vũ Khí</b>!</h3>"                   
                       " <p> Với mong muốn góp phần nâng cao chất lượng dạy và học Anh văn chuyên ngành tại trường Sĩ quan Kỹ thuật Quân sự, chúng tôi xây dựng phần mềm từ điển này nhằm cung cấp cho người sử dụng các thuật ngữ tiếng Anh vũ khí thông dụng nhất. Các thuật ngữ được lựa chọn và biên soạn từ các tài liệu vũ khí của Mỹ và NATO, kết hợp đối chiếu và so sánh với các tài liệu chuyên ngành hiện nay."
                       " <p> Để sử dụng, nhập từ cần tra vào ô <b>Tra từ</b> ở bên trái của từ điển, nghĩa của từ được thể hiện ở tab bên phải. Bên cạnh từ điển được cài đặt mặc định, người sử dụng có thể cài đặt tích hợp thêm các dữ liệu từ nguồn từ điển khác. Để tìm hiểu cách cài đặt từ điển và tìm hiểu thêm các chức năng khác của từ điển, vui lòng xem hướng dẫn ở phần <b>Giúp đỡ | Hướng dẫn</b> hoặc nhấn phím <b>F1</b>."
					   " <p> Hiện tại dữ liệu từ điển chứa hơn 1000 thuật ngữ tiếng Anh chuyên ngành Vũ khí. Tuy nhiên, từ điển vẫn đang được tiếp tục hoàn thiện, cập nhật và bổ sung để đáp ứng tốt hơn nữa nhu cầu tra cứu các tài liệu chuyên ngành nói chung và tài liệu ngành Vũ khí nói riêng. Để nhận được phiên bản mới nhất của từ điển, xin vui lòng gửi email về địa chỉ: tdn.dict@gmail.com "
                       " <p>  Chúng tôi mong muốn nhận được những đóng góp của người sử dụng để tiếp tục hoàn thiện từ điển này. Mọi ý kiến đóng góp xin gửi về theo email của tác giả. Xin chân thành cảm ơn các bạn đã quan tâm và sử dụng từ điển."
                       " <p> Nhóm tác giả:"
                       " <p>             <b>Thiếu tá, ThS Nguyễn Mạnh Hùng</b> - Email: nghungvhp@gmail.com"
                       " <p>             <b>Đại úy, ThS Lê Thị Mộng Thanh</b> - Email: thanhlevhp@gmail.com"
